...
| SUBCONFIG | [https://raw.github.../ACL4SSR_Online_AIScene_CF.ini](https://raw.githubusercontent.com/XavierXIEXIN/CF-Workers-SUB/main/config/ACL4SSR_Online_AIScene_CF.ini) | ❌ | clash、singbox等 订阅转换配置文件；默认使用仓库内置的代理优先场景分组 | 
